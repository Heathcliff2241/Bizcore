...
export function CartPage({ storefront }: CartPageProps) {
  ...
  useEffect(() => {
    setMounted(true)
    // Load tax settings from storefront
  ...
  const handleCheckout = () => {
    const checkoutUrl = resolveStorefrontHref('/checkout', storefront)
    router.push(checkoutUrl.href)
  }

  const handleContinueShopping = () => {
    const menuUrl = resolveStorefrontHref('/menu', storefront)
    router.push(menuUrl.href)
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-emerald-600 text-white px-8 py-3 rounded-lg hover:bg-emerald-700 transition-colors font-medium"
            >
              Start Shopping
